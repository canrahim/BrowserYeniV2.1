 ...
 * Form sayfasından cihazları çeker ve kullanıcıya bir dialog ile gösterir.
 * Favorileri yerel veritabanında saklar.
 * 
 * @property context Uygulama context'i
 * @property webView Cihaz listesini çekme ve işlemleri uygulama için WebView
 * 
 * Referans: Modern Kotlin Dialog ve WebView kullanımı
...
class DeviceManager(
    ...
    private val prefs = context.getSharedPreferences("DeviceFavorites", Context.MODE_PRIVATE)
    ...
    private fun showModernDeviceDialog() {
        ...
        btnSubmit.setOnClickListener {
            ...
            submitSelectedDevices(selectedIds)
     ...
     */
    private fun submitSelectedDevices(deviceIds: List<String>) {
